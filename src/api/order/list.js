...
export default {
     ...
     * 获取 订单列表
     */
    queryChargeRecord: () => new Promise((resolve, reject) => {
        // return resolve({
        //     code: 200,
        //     data: {
        ...
        let requestReason = '订单列表';
		Indicator.open('正在加载数据...'); // 弹出加载框
        $.ajax({
            url: `${config.url.originJAVA}/ycpd/v1/QueryChargeRecord/${window.localStorage.ycpd_charge_customerid}`,
            xhrFields: {
